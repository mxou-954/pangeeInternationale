...
const NewFieldModal = ({ isOpen, onClose, onSubmit }) => {
  ...
  const handleSubmit = () => {
    if (newField.name && newField.size && newField.cropType) {
      onSubmit(newField);
      resetForm();
    }
  };
  ...
  const modalSteps = [
    ...
    { id: 4, title: 'Culture & Planning', icon: Sprout },
    { id: 5, title: 'Infrastructure', icon: Settings },
    { id: 6, title: 'Objectifs & Finalisation', icon: CheckCircle }
  ];
      ...
      case 1:
        return (
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Adresse/Localisation</label>
              <input
                type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="number"
                  step="0.000001"
                  value={newField.coordinates.latitude}
                  onChange={(e) => updateField('coordinates.latitude', e.target.value)}
                  placeholder="Ex: 48.1173"
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                />
              </div>
              <div>
                ...
                <input
                  type="number"
                  step="0.000001"
                  value={newField.coordinates.longitude}
                  onChange={(e) => updateField('coordinates.longitude', e.target.value)}
                  placeholder="Ex: -1.6778"
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                />
              </div>
            </div>
        ...
        return (
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Pente (%)</label>
                <input
                  type="number"
                  step="0.1"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Stockage sur place</label>
              <input
                type="text"
        ...
        return (
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">pH du sol</label>
                <input
                  type="number"
                  step="0.1"
                  min="0"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Qualité du sol</label>
                <select
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Matière organique (%)</label>
                <input
                  type="number"
                  step="0.1"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Dernière analyse sol</label>
                <input
                  type="date"
                  value={newField.lastSoilAnalysis}
                  onChange={(e) => updateField('lastSoilAnalysis', e.target.value)}
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                />
              </div>
            </div>
      ...
      case 4:
        return (
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                >
                  ...
                  <option value="pomme-terre">Pomme de terre</option>
                  <option value="legumes">Légumes</option>
                  <option value="fruits">Fruits</option>
                </select>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Variété</label>
                <input
                  type="text"
                  value={newField.cropVariety}
                  onChange={(e) => updateField('cropVariety', e.target.value)}
                  placeholder="Ex: Apache, DKC 3420..."
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Date de plantation</label>
                <input
                  type="date"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Récolte prévue</label>
                <input
                  type="date"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Rendement espéré (kg/ha)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Rendement historique (kg/ha)</label>
                <input
                  type="number"
                  value={newField.averageYield}
                  onChange={(e) => updateField('averageYield', e.target.value)}
                  placeholder="Ex: 4200"
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Coût de production (€/ha)</label>
                <input
                  type="number"
                  value={newField.productionCost}
                  onChange={(e) => updateField('productionCost', e.target.value)}
                  placeholder="Ex: 1200"
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Revenus espérés (€/ha)</label>
                <input
                  type="number"
                  value={newField.expectedRevenue}
      ...
      case 5:
        return (
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => updateField('irrigationSystem', e.target.value)}
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                >
                  <option value="">Sélectionner</option>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Capacité irrigation (L/h)</label>
                <input
                  type="number"
                  value={newField.irrigationCapacity}
                  onChange={(e) => updateField('irrigationCapacity', e.target.value)}
                  placeholder="Ex: 5000"
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                />
              </div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Source d'eau</label>
              <select
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Risques climatiques</label>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                {['Gel', 'Grêle', 'Sécheresse', 'Inondation', 'Vent fort', 'Orage'].map(risk => (
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                {['Bio', 'Label Rouge', 'AOP', 'IGP', 'HVE', 'Demeter'].map(cert => (
        ...
        return (
          <div className="space-y-4">
            <div className="bg-blue-50 p-4 rounded-lg">
              <h4 className="font-semibold text-blue-900 mb-2">Objectifs de Durabilité</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Réduction eau (%)</label>
                  <input
                    type="number"
                    value={newField.sustainabilityGoals.waterReduction}
                    onChange={(e) => updateField('sustainabilityGoals.waterReduction', e.target.value)}
                    placeholder="Ex: 15"
                    className="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:ring-2 focus:ring-green-500"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Réduction chimique (%)</label>
                  <input
                    type="number"
                    value={newField.sustainabilityGoals.chemicalReduction}
                    onChange={(e) => updateField('sustainabilityGoals.chemicalReduction', e.target.value)}
                    placeholder="Ex: 20"
                    className="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:ring-2 focus:ring-green-500"
                  />
                </div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-3">Résumé du champ</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                <div>
                  <span className="font-medium">Nom:</span> {newField.name || 'Non défini'}
                </div>
                <div>
                  <span className="font-medium">Surface:</span> {newField.size} ha
                </div>
                <div>
                  <span className="font-medium">Culture:</span> {newField.cropType || 'Non définie'}
                </div>
                <div>
                  <span className="font-medium">Sol:</span> {newField.soilType || 'Non défini'}
                </div>
                <div>
                  <span className="font-medium">Irrigation:</span> {newField.irrigationSystem || 'Non défini'}
                </div>
                <div>
                  <span className="font-medium">Rendement espéré:</span> {newField.expectedYield} kg/ha
                </div>
              </div>
            </div>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    Vérifiez que toutes les informations obligatoires sont renseignées avant de créer le champ.
                  </p>
                </div>
              </div>
            </div>
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
        ...
        <div className="flex justify-between items-center p-6 border-b border-gray-200">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Nouveau Champ</h2>
            <p className="text-sm text-gray-600">
              Étape {modalStep} sur {modalSteps.length}: {modalSteps.find(s => s.id === modalStep)?.title}
            </p>
          </div>
          <button
            onClick={onClose}
              ...
              return (
                <div key={step.id} className="flex items-center">
                  <div className={`flex items-center justify-center w-8 h-8 rounded-full ${
                    modalStep === step.id ? 'bg-green-600 text-white' :
                    modalStep > step.id ? 'bg-green-100 text-green-600' :
        ...
        <div className="flex justify-between items-center p-6 border-t border-gray-200 bg-gray-50">
          ...
          <div className="flex gap-3">
            {modalStep < modalSteps.length ? (
              <button
                onClick={() => setModalStep(Math.min(modalSteps.length, modalStep + 1))}
              ...
              <button
                ...
                disabled={!newField.name || !newField.size || !newField.cropType}
